...
OUTPUT=`carton exec -- ./admin/cleanup/RemoveEmpty event` || echo "$OUTPUT"
...
OUTPUT=`carton exec -- ./admin/cleanup/RemoveEmpty place` || echo "$OUTPUT"
...
OUTPUT=`carton exec -- ./admin/cleanup/RemoveEmpty series` || echo "$OUTPUT"
